...
// actions
constexpr auto DOCK_ACTION_ALLWINDOW = "dock-action-allWindow";
constexpr auto DOCK_ACTION_FORCEQUIT = "dock-action-forceQuit";
constexpr auto DOCK_ACTION_CLOSEALL = "dock-action-closeAll";
constexpr auto DOCK_ACTIN_LAUNCH = "dock-action-launch";
constexpr auto DOCK_ACTION_DOCK = "dock-action-dock";
